				...
				<div className="row justify-content-center align-items-center">
					...
					<div className="col-md-6">
						<p className="description">
							...
							sed, aliquam sed leo. Integer scelerisque ullamcorper accumsan. Ut
							id lectus ligula. Maecenas dignissim elit quis pharetra feugiat.
							Mauris scelerisque felis eget arcu maximus scelerisque. Vestibulum
							in ornare nibh. Ut tortor nisl, placerat sit amet justo eu,
							malesuada Donec volutpat aliquet nunc id faucibus. Sed tincidunt
							cursus sem, vitae pellentesque ex mattis in. <br />
